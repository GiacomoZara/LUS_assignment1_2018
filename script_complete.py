...
subprocess.call("python3 compute_probabilities.py LUS.P1/data/P1_data/data/NLSPARQL.train.data", shell = True)
...
subprocess.call("python3 get_concepts_sequences.py LUS.P1/data/P1_data/data/NLSPARQL.train.data", shell = True)
